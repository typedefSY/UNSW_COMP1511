...
//
// `create_brary` will return a pointer to a new `struct library`.
//
...
// - `length` - Length (in minutes) of the provided book
// - `rating` - Rating /10 of the provided book
//
...
// ...
//
// `print_books_in+genre` takes in these parameters:
